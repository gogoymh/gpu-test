...
from net1 import NormPool2d, PoolConv2d, my_Conv2d
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        #self.conv1 = PoolConv2d(inplanes, planes, 3, stride, 1, False)
        #self.conv1 = my_Conv2d(inplanes, planes, stride)
        
        self.bn2 = norm_layer(planes)
        self.conv2 = conv3x3(planes, planes)
        #self.conv2 = PoolConv2d(planes, planes, 3, 1, 1, False)
        #self.conv2 = my_Conv2d(planes, planes)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        #self.conv1 = PoolConv2d(3, self.inplanes, 3, 1, 1, False)
